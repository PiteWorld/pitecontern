...
public class SwitchModel {
	...
	public static interface ModelWorkeSwitch {
		public void afterWorkSwitch(byte[] bt);
	}

	public ModelWorkeSwitch work = null;
	...
	public SwitchModel(ModelWorkeSwitch work) {
		this.work = work;
	}
	...
	private void updateList() {
		...
		for (int i = 0; i < revList.size(); i++) {
			...
			work.afterWorkSwitch(getBytes(revList.get(i), len));
		}
		for (int i = 0; i < rmlist.size(); i++) {
			revList.remove(rmlist.get(i));
		}
